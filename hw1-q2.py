...
def main():
    ...
    for ii in epochs:
        ...
        #test_accs.append(evaluate(model, test_X, test_y))
    ...
    #plot(epochs, test_accs, ylabel='Accuracy', name='{}-test-accuracy-{}'.format(opt.model, config))

if __name__ == '__main__':
    main()

#0.1LR Final Test acc: 0.6133
#0.01LR Final Test acc: 0.6806
#0.001LR Final Test acc: 0.7019

#0.01/100/1/0.3/reluFF Final Test acc: 0.8600
#0.1FF Final Test acc: 0.8681
#0.001FF Final Test acc: 0.7449
#200FF Final Test acc: 0.8817
#0.5FF Final Test acc: 0.8410
#tanhFF Final Test acc: 0.8289
#2FF Final Test acc: 0.8724
#3FF Final Test acc: 0.8559
#BESTFF Final Test acc: 0.8954